...
> You can access the course website at [mth-321ab-fa24](https://upmathematics.github.io/mth-321ab-fa24/){target="_blank"}. The website can also be viewed in Teams.
...
> The Teams for this course is [MTH-321AB-fa24](https://teams.microsoft.com/l/team/19%3AzQECcIYWQSQjSz8yuRrBWpdpVUkkD40RJOjHcC0C5bw1%40thread.tacv2/conversations?groupId=a560fff5-4e2f-4367-bbaf-e8584d01eefc&tenantId=ea8f3949-231c-40b6-a33f-56873af96f87){target="_blank"}. I recommend that you install the Teams software on your own machine for easy and stable access, instead of accessing Teams on the browser.

Note that most of the content can be accessed in Teams which includes the course website, course Moodle page, Desmos, and Wolfram.
...
We will be using Desmos as our online graphing calculator for our in-class activities and out-class activities.

* [*Desmos*](https://www.desmos.com/){target="_blank"} is a powerful online graphing calculator that allows you to visualize and explore mathematical functions. You can manipulate parameters and sliders to observe how changes in equations affect the graph.
...
*Amendment 4:* Walk-in Help Hours was changed from 1:00 PM - 2:00 PM to 4:00 PM - 5:00 PM.
...
| **Missing or Late <br> (M)** | The work is either not submitted, incomplete (*entirely or partially*), or submitted *significantly* late. |

*Note that these are categorical grades (not scores).*

*Amendment 1:* The grade category "M" was changed from "Missing (M)" to "Missing or Late (M)" and its description was changed from "Work is not submitted or missing" to "The work is either not submitted, incomplete (*entirely or partially*), or submitted *significantly* late."
...
*Amendment 2:* The paragraph "If you have not submitted a homework assignment, which usually means you missed the deadline, that homework is an automatic *M*. If you have received an *M* mark, you can still submit your work and it will be evaluated normally with feedback but you won't have the chance to revise" was deleted.
...
*Amendment 3:* The sentence "Missing homework is disqualified for revisions, but you can still use them as practice" was changed to "Homework marked with "M" is disqualified for revisions, but you can still use them as practice". The new sentence was moved to a new bullet point.
...
*Amendment 5:* The sentence "The oral exam is only ten to fifteen minutes and it consists of one or two problems similar to the written exam with added questions from me" was changed to "The oral exam lasts only ten to fifteen minutes and includes predetermined questions about problems from the written exam, which are provided to the student ahead of time."
...
>
> * [Ordinary Differential Equation Exam Sign-Up](https://calendly.com/alexjohnquijano/ordinary-differential-equation-exam){target="_Blank"} <br> *Click on the link to sign-up for a 15-minute session.*
...
>
>   * **Section A:** December 11, W 1:30 PM - 3:30 PM, Shiley 206
>   * **Section B:** December 12, Th, Th 8:00 AM - 10:00 AM, Shiley 206
