...
|  | Th 8/29 | Modeling Physical Systems,<br>Classification of Equations, & <br>Principles of Solutions | Classify ODEs and Verifying Solutions | - | Ch. 1.1 [T], Ch. 1.1 [H], & Ch. 1.2.3 [H] |
| **2** | Tu 9/3 | 1st-Order ODEs,<br>Existence and Uniqueness, &<br>Analyzing Equilibriums of 1st-Order ODEs | Analyze 1st-Order ODEs Qualitatively | Assigned: Homework 1 | Ch. 1.2 [T], Ch. 2.1 [T], Ch. 1.3.1 [H], & Ch. 1.4 [H] |
...
| **3** | Tu 9/10 | Separation of Variables for Solving 1st-Order ODEs | Separate the Variables | Assigned: Homework 2 | Ch. 2.2 [T] & Ch. 2.1 [H] |
|  | Th 9/12 | Integrating Factors for Solving 1st-Order ODEs | Choose an Integrating Factor | - | Ch. 2.6 [T] |
| **4** | Tu 9/17 | Laplace Transforms for Solving 1st-Order ODEs | Introduce the Laplace Transform | - | Ch. 8.1 [T], Ch. 8.2 [T], & Ch. 5.1 [H] |
