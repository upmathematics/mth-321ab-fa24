...
| **13** | Tu 11/19 | Analyzing Higher-Order Linear ODEs  | Use Substitutions and Matrix Exponentials | - | - |
...
Along with the textbook [T], and websites [C] and [P], some of the course materials (contents of worksheets and homework) of each topic was taken from these following sources:
