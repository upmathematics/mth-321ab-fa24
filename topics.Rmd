...
|  | Th 11/7 | Analyzing Higher-Order Linear ODEs | Use Substitutions and Matrix Exponentials | Assigned: Homework 5 | TBA |
| **12** | Tu 11/12 | Undetermined Coefficients for Solving Linear Higher-Order ODEs | Determine the Undetermined | - | TBA |
|  | Th 11/14 | Variation of Parameters for Solving Linear Higher-Order ODEs | Vary the Parameters | Assigned: Homework 6 | TBA |
| **13** | Tu 11/19 | Laplace Transforms for Solving Linear Higher-Order ODEs | Transform the Derivatives | - | - |
